...
export const AI_MAILBOXES: PlannedMailbox[] = [
  ...
  {
    address: "aria.tth@nexatect.com",
    display_name: "Aria — Travel & hospitality",
    kind: "industry",
    note: "Industry desk.",
    agent: "Aria",
  },
  {
    address: "orion.airlines@nexatect.com",
    display_name: "Captain Orion — Airlines",
    kind: "industry",
    note: "Industry desk.",
    agent: "Captain Orion",
  },
  {
    address: "rex@nexatect.com",
    display_name: "Rex — Car rental",
    kind: "industry",
    note: "Industry desk.",
    agent: "Rex",
  },
  {
    address: "lyra@nexatect.com",
    display_name: "Dr. Lyra — Healthcare",
    kind: "industry",
    note: "Industry desk.",
    agent: "Dr. Lyra",
  },
  {
    address: "sage.education@nexatect.com",
    display_name: "Professor Sage — Education",
    kind: "industry",
    note: "Industry desk.",
    agent: "Professor Sage",
  },
  {
    address: "atlas.logistics@nexatect.com",
  ...
  {
    address: "vega.ee@nexatect.com",
    display_name: "Vega — Events & entertainment",
    kind: "industry",
    note: "Industry desk.",
    agent: "Vega",
  },
  {
    address: "kai.railways@nexatect.com",
    display_name: "Conductor Kai — Railways",
    kind: "industry",
    note: "Industry desk.",
    agent: "Conductor Kai",
  },
