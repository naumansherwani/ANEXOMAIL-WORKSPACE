...
const GROUPS: { title: string; blurb: string; items: Entry[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        note: "Founder view: kill switch, tenant totals, team permissions, CRM audit (founderworkspace host only)",
        auth: true,
      },
      {
        label: "Founder org control",
        path: "/app/founder/org",
        note: "Founder view: global write freeze, per-tenant freeze, seats, MRR truth, ledger health (founderworkspace host only)",
        auth: true,
      },
      {
      ...
      },
      {
        ...
        note: "Phase 21 founder view — MRR, ARR, unpaid, churn, by-plan split across every tenant",
        auth: true,
      },
      {
        label: "Founder integrations founder view",
        path: "/app/founder/integrations",
        note: "Phase 22 founder view — connections, re-auth queue, migration failures, worst delivery scores",
        auth: true,
      },
      {
        label: "Founder settings founder view",
        path: "/app/founder/settings",
        note: "Phase 23 founder view — changes 24h, reverts 7d, riskiest tenants, most-changed settings, pending scheduled",
        auth: true,
      },
      {
        label: "Founder analytics founder view",
        path: "/app/founder/analytics",
        note: "Phase 24 founder view — platform response debt in £, keep rate, worst tenants",
      },
      {
        label: "Founder admin founder view",
        path: "/app/founder/admin",
        note: "Phase 25 founder view — failing checks, self-heals, incidents, held mail, storage across every tenant",
        auth: true,
      },
      {
        label: "Founder security founder view",
        path: "/app/founder/security",
        note: "Phase 26 founder view — anomalies, frozen accounts, blocked devices, kill switches per tenant",
        auth: true,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Founder speed founder view",
        path: "/app/founder/perf",
        note: "Phase 27 founder view — p95 per tenant, failing budgets, regressions",
        auth: true,
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        label: "Founder revenue founder view",
