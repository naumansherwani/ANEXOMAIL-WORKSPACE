...
/**
 * Phase 25 — Founder view (founderworkspace.anexomail.com).
...
export const Route = createFileRoute("/app/founder_/admin")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Platform-wide health, incidents, delivery and storage in one founder view.",
      },
      { property: "og:title", content: "Founder · Admin control — ANEXOMAIL" },
      {
        property: "og:description",
        content: "Every tenant's health, incidents and delivery in one place.",
      },
    ...
    <div className="min-h-0 flex-1 overflow-y-auto">
      <div className="mx-auto w-full max-w-3xl px-6 py-8 md:px-8">
        <Section
          eyebrow={
            <>
              <ShieldCheck className="size-3.5" aria-hidden="true" /> Founder · Admin control
            </>
          }
