  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-8 md:px-8">
      <Section
        eyebrow={
          <>
            <Banknote className="size-3.5" aria-hidden="true" /> Founder view
          </>
        }
            ...
            <>
              <div className="grid gap-ax-3 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <Stat
                  ...
                  value={gbp(d.one_off_gbp)}
                  hint="migrations, this month"
                />
              ...
              <div className="ax-plane mt-ax-6 rounded-2xl p-5">
                ...
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  {d.gap.seats_needed} more {d.gap.plan} seats close the {gbp(d.target_gbp)} target.{" "}
                  {d.gap.note}
                </p>
              </div>
