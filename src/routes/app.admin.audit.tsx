...
export const Route = createFileRoute("/app/admin/audit")({
  head: () => ({
    meta: [{ title: "Audit — ANEXOMAIL Admin" }, { name: "robots", content: "noindex" }],
  }),
  component: AuditPage,
});
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-10 md:px-10">
      ...
      <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
        Sign-ins, role changes, address changes, exports and revokes — recorded with who, what, when
        and from where. Readable by owners and admins, deletable by nobody.
      </p>
