  ...
  head: () => ({
    meta: [
      { title: "Launch · Deployments · Founder view — ANEXOMAIL Workspace" },
      {
        name: "description",
        content:
          "Launch · Deployments · Founder view in ANEXOMAIL Workspace — real readings from your own workspace, with proof of where every number came from.",
      },
      {
        property: "og:title",
        content: "Launch · Deployments · Founder view — ANEXOMAIL Workspace",
      },
      {
