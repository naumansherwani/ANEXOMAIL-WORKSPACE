  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-8 md:px-8">
      <Section
        eyebrow={
          <>
            <Radar className="size-3.5" aria-hidden="true" /> Delivery watchtower
          </>
        }
            ...
            <>
              <div className="grid gap-ax-3 sm:grid-cols-2 lg:grid-cols-4">
                <Stat
                  label="Delivered"
                  value={String(d.sent)}
                  hint={`${d.delivery_rate}% of attempts`}
                />
                ...
                <Stat
                  ...
                  value={String(d.bounced + d.rejected)}
              ...
              <ul className="mt-ax-3 space-y-1.5">
                {d.recent.map((e) => (
                  <Row key={e.id}>
                    ...
                    <span className="ml-auto min-w-0 truncate text-steel">
                      {e.human_reason ?? ""}
                    </span>
                  </Row>
                ))}
